...
TEXT -112 -48 Bottom 2 T
WINDOW 39 -10 32 Center 2
WINDOW 0 16 -29 Left 2
SYMATTR SpiceLine Lind=200n thickness=4n sheetRes=300 Tb=2 Tc=10 Jc=50G Gv=15e-8 C=0.5
SYMATTR Prefix X
SYMATTR SpiceModel nanowire_thermal_port
SYMATTR Description snspd with gate
SYMATTR ModelFile snspd_thermal_port.lib
PIN -64 -48 NONE 8
